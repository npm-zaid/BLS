    ...
    <div className="min-h-screen w-full text-white p-6">
      <div className="bg-zinc-800/80 p-6 rounded-lg shadow-md">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-zinc-800/90 p-4 rounded-lg shadow-md border-l-4 border-teal-400">
            ...
            <div className="w-full">
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  <div
                    key={index}
                    className="grid grid-cols-1 md:grid-cols-[1fr_3fr_1fr] gap-4 bg-zinc-700/40 p-4 rounded-lg shadow-md hover:shadow-xl hover:bg-teal-400/10 hover:text-white text-teal-400 transition-all duration-300 border-l-2 border-transparent hover:border-teal-400"
                  >
                    ...
                    <div className="text-gray-200 font-medium flex items-center gap-2 md:text-base text-sm">
